# 1 "check_shelstring.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "check_shelstring.c"
# 1 "/usr/include/check.h" 1 3 4
# 25 "/usr/include/check.h" 3 4
...
# 27 "/usr/include/check.h" 2 3 4

# 1 "/usr/include/check_stdint.h" 1 3 4
...
# 8 "/usr/include/check_stdint.h" 2 3 4
# 29 "/usr/include/check.h" 2 3 4
# 62 "/usr/include/check.h" 3 4
...
# 1195 "/usr/include/check.h" 3 4
 enum fork_status srunner_fork_status(SRunner * sr);
# 1214 "/usr/include/check.h" 3 4
 void srunner_set_fork_status(SRunner * sr,
                                                  enum fork_status fstat);
# 1233 "/usr/include/check.h" 3 4
 pid_t check_fork(void);
# 1247 "/usr/include/check.h" 3 4
 void check_waitpid_and_exit(pid_t pid) __attribute__ ((noreturn));
# 2 "check_shelstring.c" 2
# 1 "shelstring.h" 1
# 9 "shelstring.h"
...
const long max_sizes[4] = {127,16384,2097152,268435456};
...
# 63 "shelstring.h" 2
# 3 "check_shelstring.c" 2



static void test_a (int _i __attribute__ ((unused))){ tcase_fn_start ("""test_a", "check_shelstring.c", 6);{
  int tests[8] = {0, 1, 5, 127,128,255,16383,16384};
  short res[8] = {1, 1, 1, 1, 2, 2, 2, 3};
  for(int i=0;i<8;i++){
    do { intmax_t _ck_x = (res[i]); intmax_t _ck_y = (shelint_length_from_cint(tests[i])); (_ck_x == _ck_y) ? _mark_point("check_shelstring.c", 10) : _ck_assert_failed("check_shelstring.c", 10, "Assertion '""_ck_x == _ck_y""' failed" , "Assertion '%s' failed: %s==%jd, %s==%jd", "res[i]""==""shelint_length_from_cint(tests[i])", "res[i]", _ck_x, "shelint_length_from_cint(tests[i])", _ck_y, ((void *)0)); } while (0);
  }
}};

static void wat (int _i __attribute__ ((unused))){ tcase_fn_start ("""wat", "check_shelstring.c", 14);{
  do { intmax_t _ck_x = (1); intmax_t _ck_y = (2); (_ck_x == _ck_y) ? _mark_point("check_shelstring.c", 15) : _ck_assert_failed("check_shelstring.c", 15, "Assertion '""_ck_x == _ck_y""' failed" , "Assertion '%s' failed: %s==%jd, %s==%jd", "1""==""2", "1", _ck_x, "2", _ck_y, ((void *)0)); } while (0);
}};
